...
// function filter (diving)

function filterDiving(arr, diving) {
  ...
  let arrNew = arr.filter(item => item.diving === diving); // filter array of products
...
export default filterDiving; // export filter (diving)
