...
import createHeaderCut from '/bs-shop-full-version/js/create-html/create-header-cut.js'; // cut <header> (all without Index.html)
...
import createAccount from '/bs-shop-full-version/js/create-html/create-account.js'; // account
